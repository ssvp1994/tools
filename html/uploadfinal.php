...
if (isset ($_POST['submit'])){
	...
	if (in_array($fileActualExt,$allowed) ){
		if($fileError===0){
			$fileNameNew = 'compress'.'.'.$fileActualExt;
...
<div class="same">
<a href="trouble.html">Troubleshoot </a></div>
...
<form action="./cgi-bin/test1.py">
<p>You have selected a zip file, click to combine files in zip<span id ="filename"></span></p>
<div id="in1">
